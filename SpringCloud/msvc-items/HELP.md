...
* The original package name 'com.damian.springcloud.msvc.items.msvc-items' is invalid and this project uses 'com.damian.springcloud.msvc.items.msvc_items' instead.
